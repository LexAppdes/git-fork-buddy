    ...
    <div className="h-full p-6 bg-[#fafafa]">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground">Manage your long-term objectives and track progress</p>
        </div>
            ...
            <PopoverContent className="w-80" align="end">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {["new", "active", "paused", "achieved", "archive"].map(status => (
          ...
          <Popover>
            ...
            <PopoverContent className="w-48" align="end">
              <div className="space-y-2">
                ...
                <Button
                  variant={sortBy === "area" ? "default" : "ghost"}
                  className="w-full justify-start"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <InlineDateTimePicker
                      ...
                      onDateChange={(date) => setNewGoal(prev => ({ ...prev, startDate: date }))}
                      showTime={false}
                      allowClear={true}
                    >
                      <Button variant="outline" className="w-full justify-start">
                        <Calendar className="w-4 h-4 mr-2" />
                        {newGoal.startDate ? formatSimpleDate(newGoal.startDate) : "Pick date"}
                      </Button>
                    </InlineDateTimePicker>
                  </div>
                  ...
                  <div>
                    ...
                    <InlineDateTimePicker
                      ...
                      onDateChange={(date) => setNewGoal(prev => ({ ...prev, endDate: date }))}
                      showTime={false}
                      allowClear={true}
                    >
                      <Button variant="outline" className="w-full justify-start">
                        <Calendar className="w-4 h-4 mr-2" />
                        {newGoal.endDate ? formatSimpleDate(newGoal.endDate) : "Pick date"}
                      </Button>
                    </InlineDateTimePicker>
                  </div>
                </div>
