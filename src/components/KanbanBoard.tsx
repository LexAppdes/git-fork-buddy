...
const KanbanColumn = ({
  ...
  return <div className={cn("flex-1 min-w-0 bg-muted/30 rounded-lg border border-border border-t-4 transition-colors", getColumnColor(), isDragOver && "bg-muted/50")} onDragOver={handleDragOver} onDragLeave={handleDragLeave} onDrop={handleDrop}>
      <div className="p-4">
...
export function KanbanBoard({
  ...
  return <div className="h-full w-full bg-background p-4">
